...
function updatePassword(oldPasswordClass, newPasswordClass1, newPasswordClass2) {
    ...
    { oldPassword: oldPassword, newPassword1: newPassword1, 
        newPassword2: newPassword2, username: userLoggedIn })
    .done(function(response) {
...
function  openPage(url) {
    ...
    // if theres no question mark in the url, then one is inserted
    if(url.indexOf("?") == -1) {
        url = url + "?";
    }
